+++
author = "Jesse Lima"
title = "Provenance of Machine Learning experiments with noWorkflow"
date = "2023-09-17"
...
```
![](/images/trial_intersect_diff.png)
...
```
![roc](/images/var_tag_plot_roc.png )
...
```
![f1](/images/tag_values_f1.png )

```python
var_tag_values('model')
```
![model](/images/tag_values_model.png )
